# Generated by Powerlevel10k configuration wizard on 2025-12-08 at 23:14 EST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%244F\uE0B1'  # > symbol
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%246F$'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%n@${HOST[-4,-1]}"  # '%n@%m'
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='\b%246F=>> '
